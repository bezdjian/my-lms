...
<c:set var="realContextPath" value="${pageContext.request.getRealPath('/resources/uploads/')}"/>
...
<nav class="navbar navbar-inverse">
    <div class="container-fluid navbar-inner">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li>
                <a href="<c:url value="/" /> ">
                    <span>${person.firstname} ${person.lastname}, <span style="text-transform: capitalize">${person.role}</span></span>
